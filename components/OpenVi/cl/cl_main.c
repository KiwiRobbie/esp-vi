...
int main(int argc, char *argv[])
{
        ...
        ESP_LOGI("cl_main", "Term type: %s", ttype);
        ...
        ESP_LOGI("cl_main", "Term size: %d x %d", rows, cols);
        ...
        ESP_LOGI("cl_main", "Add the rows and columns to the global structure.");
